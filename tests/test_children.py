...
class TestChildrenTwine(BaseTestCase):
    ...
    def test_invalid_children_dict_not_array(self):
        ...
        """
        twine_file = os.path.join(self.path, "twines", "invalid_children_dict_not_array_twine.json")
    ...
    def test_invalid_children_no_key(self):
        ...
        """
        twine_file = os.path.join(self.path, "twines", "invalid_children_no_key_twine.json")
        with self.assertRaises(exceptions.InvalidTwine):
            Twine(source=twine_file)
    ...
    def test_valid_children(self):
        ...
        """
        twine_file = os.path.join(self.path, "twines", "valid_children_twine.json")
    ...
    def test_empty_children(self):
        ...
        """
        twine_file = os.path.join(self.path, "twines", "valid_empty_children_twine.json")
        twine = Twine(source=twine_file)
...
class TestChildrenValidation(BaseTestCase):
    ...
    def test_missing_children(self):
        ...
        """
        twine = Twine(source=os.path.join(self.path, "twines", "valid_children_twine.json"))
    ...
    def test_extra_property(self):
        ...
        """
        twine = Twine(source=os.path.join(self.path, "twines", "valid_children_twine.json"))
        twine.validate_children(source=os.path.join(self.path, "children", "extra_property.json"))
